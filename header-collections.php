...
<div id="introduction">
	<header>
		<!-- <div class="contact-banner">
			<div class="swatches" onclick="location.href='/swatches/'">SWATCHES <img src="<?php echo get_template_directory_uri(); ?>/img/swatch-icon.png" /> <span class="swatch-count"><a href="/swatches/"><?php echo sizeof(jigoshop_cart::$cart_contents); ?></a></span></div>
		</div> -->
		<nav>
			<?php 
				$defaults = array(	
